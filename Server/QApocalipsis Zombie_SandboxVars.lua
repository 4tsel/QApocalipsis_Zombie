SandboxVars = {
    VERSION = 4,
    -- Cambiando esto se establece la opción avanzada \Multiplicador de Población\. Por defecto
    -- 1 = Zombicidio
    -- 2 = Muy alto
    -- 3 = Alto
    -- 4 = Normal
    ...
    -- 4 = Común
    LiteratureLoot = 2,
    -- Semillas, clavos, sierras, cañas de pescar, herramientas diversas, etc... Por defecto
    -- 1 = Bastante raro
    -- 2 = Raro
    -- 3 = Normal
    -- 4 = Común
    ...
    -- 4 = Común
    OtherLoot = 2,
    -- Controla la temperatura global. Por defecto
    -- 1 = Mucho frío
    -- 2 = Frío
    -- 3 = Normal
    -- 4 = Calor
    Temperature = 3,
    -- Controla la frecuencia de las lluvias. Por defecto
    -- 1 = Muy seco
    -- 2 = Seco
    -- 3 = Normal
    -- 4 = Lluvioso
    Rain = 3,
    -- Número de días hasta el 100% de crecimiento. Por defecto
    ...
    -- Controla la velocidad de crecimiento de las plantas. Por defecto
    -- 1 = Muy rápido
    -- 2 = Rápido
    -- 3 = Normal
    -- 4 = Lento
    Farming = 3,
    -- Controla el tiempo que tardan los alimentos en descomponerse en un compostador. Por defecto
    -- 1 = 1 Semana
    -- 2 = 2 Semanas
    -- 3 = 3 Semanas
    -- 4 = 4 Semanas
    ...
    -- 7 = 10 Semanas
    CompostTime = 2,
    -- La rapidez con que disminuyen el hambre, la sed y el cansancio del personaje. Por defecto
    -- 1 = Muy rápido
    -- 2 = Rápido
    -- 3 = Normal
    -- 4 = Lento
    StatsDecrease = 3,
    -- Controla la abundancia de peces y en general al rebuscar. Por defecto
    -- 1 = Muy pobre
    -- 2 = Pobre
    -- 3 = Normal
    -- 4 = Abundante
    ...
    -- 5 = A menudo
    Alarm = 4,
    -- Con qué frecuencia se encontrarán las casas y los edificios cerrados con llave. Por defecto
    -- 1 = Nunca
    -- 2 = Muy raro
    -- 3 = Raro
    -- 4 = A veces
    ...
    Nutrition = true,
    -- Define lo rápido que se estropeará la comida dentro o fuera de la nevera. Por defecto
    -- 1 = Muy rápido
    -- 2 = Rápido
    -- 3 = Normal
    -- 4 = Lento
    FoodRotSpeed = 3,
    -- Establece la eficacia del frigorífico. Por defecto
    -- 1 = Muy baja
    -- 2 = Baja
    -- 3 = Normal
    -- 4 = Alta
    FridgeFactor = 3,
    -- Los objetos volverán a aparecer en los contenedores ya saqueados de las ciudades. Los objetos no volverán a aparecer en los contenedores fabricados por los jugadores. Por defecto
    -- 1 = Nada
    -- 2 = Cada día
    -- 3 = Cada semana
    -- 4 = Cada mes
    ...
    -- Afectará a la erosión inicial del mundo y al deterioro de los alimentos. Por defecto
    -- 1 = 0
    -- 2 = 1
    -- 3 = 2
    -- 4 = 3
    ...
    -- 12 = 11
    TimeSinceApo = 1,
    -- Influirá en la cantidad de agua que la planta perderá por día y en su capacidad para evitar enfermedades. Por defecto
    -- 1 = Muy alto
    -- 2 = Alto
    -- 3 = Normal
    -- 4 = Bajo
    PlantResilience = 3,
    -- Controla la producción de las plantas cuando se cosechan. Por defecto
    -- 1 = Muy pobre
    -- 2 = Pobre
    -- 3 = Normal
    -- 4 = Abundante
    PlantAbundance = 3,
    -- Recuperación del cansancio por realizar acciones Por defecto
    -- 1 = Muy rápido
    -- 2 = Rápido
    -- 3 = Normal
    -- 4 = Lento
    EndRegen = 3,
    -- Con qué frecuencia pasan los helicópteros por la zona de eventos. Por defecto
    -- 1 = Nunca
    -- 2 = Una vez
    -- 3 = A veces
    Helicopter = 2,
    -- Con qué frecuencia se producirán eventos que atraigan a los zombis, como disparos lejanos. Por defecto
    -- 1 = Nunca
    -- 2 = A veces
    MetaEvent = 2,
    -- Regula los eventos nocturnos mientras el personaje duerme. Por defecto
    -- 1 = Nunca
    -- 2 = A veces
    SleepingEvent = 1,
    -- Aumenta o disminuye la probabilidad de aparición en el mapa de generadores eléctricos. Por defecto
    -- 1 = Muy raro
    -- 2 = Raro
    -- 3 = A veces
    -- 4 = A menudo
    ...
    -- Aumentar/disminuir la probabilidad de descubrir refugios aleatorios en el mapa: ya sea quemados, que contengan reservas secretas, cadáveres de supervivientes, etc. Por defecto
    -- 1 = Nunca
    -- 2 = Muy raro
    -- 3 = Raro
    -- 4 = A veces
    ...
    -- 5 = A menudo
    ZoneStoryChance = 3,
    -- Determina la frecuencia con la que un mapa puede tener anotaciones de un superviviente muerto. Por defecto
    -- 1 = Nunca
    -- 2 = Muy raro
    -- 3 = Raro
    -- 4 = A veces
    ...
    -- Proporciona a las construcciones creadas por los jugadores puntos de impacto adicionales para que sean más resistentes al daño de los zombis. Por defecto
    -- 1 = Muy bajo
    -- 2 = Bajo
    -- 3 = Normal
    -- 4 = Alto
    ConstructionBonusPoints = 3,
    -- Controla la iluminación ambiental por la noche. Por defecto
    -- 1 = Noche cerrada
    -- 2 = Oscuro
    -- 3 = Normal
    NightDarkness = 3,
    -- Controla el tiempo desde el atardecer hasta el amanecer. Por defecto
    -- 1 = Siempre de noche
    -- 2 = Largo
    -- 3 = Normal
    -- 4 = Corto
    NightLength = 3,
    -- Aumenta o disminuye el impacto de las lesiones en tu cuerpo, así como el tiempo de curación. Por defecto
    -- 1 = Bajo
    -- 2 = Normal
    InjurySeverity = 2,
    ...
    -- Ajusta el impacto que tendrá en la salud y las emociones del personaje los cadáveres en descomposición cercanos a él. Por defecto
    -- 1 = Ninguno
    -- 2 = Bajo
    -- 3 = Normal
    DecayingCorpseHealthImpact = 3,
    -- La cantidad de sangre que salpica el suelo y las paredes. Por defecto
    -- 1 = Ninguno
    -- 2 = Bajo
    -- 3 = Normal
    -- 4 = Alto
    BloodLevel = 4,
    -- Controla la rapidez con la que la ropa se deteriora, se ensucia y se llena de sangre. Por defecto
    -- 1 = Deshabilitado
    -- 2 = Lento
    -- 3 = Normal
    ...
    -- Controla la intensidad máxima de la niebla. Por defecto
    -- 1 = Normal
    -- 2 = Moderada
    MaxFogIntensity = 1,
    -- Controla la intensidad máxima de la lluvia. Por defecto
    -- 1 = Normal
    -- 2 = Moderado
    ...
    -- Posibilidad de ser mordido cuando un zombi ataca por detrás. Por defecto
    -- 1 = Bajo
    -- 2 = Medio
    RearVulnerability = 2,
    ...
    -- Regula la frecuencia con la que se encuentran los coches en el mapa. Por defecto
    -- 1 = Ninguno
    -- 2 = Muy bajo
    -- 3 = Bajo
    -- 4 = Normal
    CarSpawnRate = 3,
    -- Determina la probabilidad de encontrar vehículos con combustible en el depósito. Por defecto
    -- 1 = Bajo
    -- 2 = Normal
    ChanceHasGas = 2,
    -- Determina qué tan llenos estarán los tanques de gasolina en los vehículos encontrados. Por defecto
    -- 1 = Muy bajo
    -- 2 = Bajo
    -- 3 = Normal
    -- 4 = Alto
    -- 5 = Muy alto
    InitialGas = 2,
    -- Determina el nivel de combustible de los depósitos de gasolina en las estaciones de servicio. Por defecto
    -- 1 = Vacío
    -- 2 = Muy bajo
    -- 3 = Bajo
    -- 4 = Normal
    ...
    -- 5 = A menudo
    LockedCar = 4,
    -- Estado general de los vehículos encontrados en el mapa. Por defecto
    -- 1 = Muy bajo
    -- 2 = Bajo
    -- 3 = Normal
    -- 4 = Alto
    CarGeneralCondition = 2,
    -- Determina la cantidad de daños causados a los vehículos en caso de colisión. Por defecto
    -- 1 = Muy bajo
    -- 2 = Bajo
    -- 3 = Normal
    -- 4 = Alto
    CarDamageOnImpact = 3,
    -- Daño que recibe el jugador del vehículo en una colisión. Por defecto
    -- 1 = Ninguno
    -- 2 = Bajo
    -- 3 = Normal
    -- 4 = Alto
    ...
    TrafficJam = true,
    -- Frecuencia con la que se descubren coches con alarma. Por defecto
    -- 1 = Nunca
    -- 2 = Muy raro
    -- 3 = Raro
    -- 4 = A veces
    ...
    --  Determina si el jugador puede encontrar un vehículo que haya sido conservado y acondicionado después de que se haya producido la infección. Por defecto
    -- 1 = Bajo
    -- 2 = Normal
    ...
    ZombieLore = {
        -- Controla la velocidad de movimiento de los zombis. Por defecto
        -- 1 = Velocistas
        -- 2 = Tambaleantes veloces
        -- 3 = Tambaleantes
        Speed = 2,
        -- Controla el daño que infligen los zombis por ataque. Por defecto
        -- 1 = Superhumano
        -- 2 = Normal
        -- 3 = Débil
        Strength = 2,
        -- Controla la dificultad para matar zombis. Por defecto
        -- 1 = Duro
        -- 2 = Normal
        -- 3 = Frágil
        Toughness = 2,
        -- Controla cómo se propaga el virus zombi. Por defecto
        -- 1 = Sangre + saliva
        -- 2 = Sólo saliva
        -- 3 = Todos están infectados
        Transmission = 1,
        -- Controla la rapidez con la que la infección hace efecto. Por defecto
        -- 1 = Instantáneo
        -- 2 = 0-30 segundos
        -- 3 = 0-1 minuto
        -- 4 = 0-12 horas
        ...
        -- 6 = 1-2 semanas
        Mortality = 5,
        -- Controla la rapidez con la que los cadáveres se levantan como zombis. Por defecto
        -- 1 = Instantáneo
        -- 2 = 0-30 segundos
        -- 3 = 0-1 minuto
        -- 4 = 0-12 horas
        -- 5 = 2-3 días
        Reanimate = 3,
        -- Controla la inteligencia de los zombis. Por defecto
        -- 1 = Exploración + usar las puertas
        -- 2 = Exploración
        -- 3 = Exploración básica
        Cognition = 3,
        -- Controla qué zombis pueden arrastrarse bajo los vehículos. Por defecto
        -- 1 = Sólo reptantes
        ...
        -- 6 = Muy a menudo
        CrawlUnderVehicle = 5,
        -- Controla durante cuánto tiempo los zombis recuerdan a los jugadores después de haberlos visto o escuchado. Por defecto
        -- 1 = Larga
        -- 2 = Normal
        -- 3 = Corta
        Memory = 3,
        -- Controla los efectos de la descomposición en el tiempo. Por defecto
        -- 1 = Lentos + débiles
        -- 2 = Lentos
        -- 3 = Débiles
        Decomp = 1,
        -- Controla el radio de visión de los zombis. Por defecto
        -- 1 = Vista de águila
        -- 2 = Normal
        Sight = 2,
        -- Controla el radio de audición de los zombis. Por defecto
        -- 1 = Preciso
        -- 2 = Normal
        Hearing = 2,
        ...
        -- Controla si los zombis son más activos durante el día o si actúan más de noche.  Los zombis activos utilizarán la velocidad establecida en el ajuste "Velocidad". Los zombis inactivos serán más lentos y tenderán a no perseguir. Por defecto
        -- 1 = Ambos
        -- 2 = Noche
        ActiveOnly = 1,
    ...
    FuelAPI = {
        -- Mínimo=100,00 Máximo=5000,00 Por defecto=400,00
        BarrelMaxCapacity = 400.0,
        -- Mínimo=0,00 Máximo=1,00 Por defecto=0,50
